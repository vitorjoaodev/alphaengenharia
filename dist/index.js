...
var SHEET_ID = "13okiOKuxqznV62jsqiWTFz5RevTgX5NWgSb3Yp3Kc1E";
var RANGE = "A:G";
...
async function registerRoutes(app2) {
  app2.post("/api/contact", async (req, res) => {
    try {
      ...
      res.json({
        success: true,
        message: "Obrigado! Nossa equipe entrar\xE1 em contato em breve! At\xE9 logo ;)",
        id: message.id
      });
    } catch (error) {
      if (error instanceof z.ZodError) {
        res.status(400).json({
          success: false,
          message: "Dados inv\xE1lidos fornecidos.",
          errors: error.errors
        });
      } else {
